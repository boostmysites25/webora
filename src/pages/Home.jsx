...
import visionImg from "../assets/vision of company.png";
    ...
    <>
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="wrapper relative z-10">
          <div className="mx-auto flex flex-col-reverse gap-6 md:grid max-w-7xl items-center md:gap-12 grid-cols-2">
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[2.5rem] border border-white/15 bg-white/[0.04] p-10 shadow-[0_45px_75px_-25px_rgba(15,23,42,0.65)] backdrop-blur-xl">
                ...
                <p className="description mt-6 text-lg leading-relaxed text-white/80">
                  ...
                  trusted partner in digital transformation—helping
                  organizations turn ideas into powerful realities through
            ...
            <div className="flex relative h-full items-center justify-center w-full">
              ...
              <div className="relative aspect-video h-full w-full overflow-hidden rounded-[2.25rem] border border-white/10 bg-gradient-to-br from-primary/30 via-primary/10 to-transparent p-[1px]">
                <div className="relative h-full w-full overflow-hidden rounded-[2rem] bg-[#070b21]">
              <img
                src={visionImg}
                alt="vision of our company"
